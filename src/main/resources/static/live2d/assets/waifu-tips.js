...
//看板娘样式设置
live2d_settings['waifuSize']            = '250x224';    // 看板娘大小，例如 '280x250', '600x535'
live2d_settings['waifuTipsSize']        = '180x40';     // 提示框大小，例如 '250x70', '570x150'
...
live2d_settings['homePageUrl']          = 'http://127.0.0.1:8080';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'http://127.0.0.1:8080/about';   // 关于页地址, '{URL 网址}'
